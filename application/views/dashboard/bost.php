...
<body>
  ...
  <nav class="navbar bg-body-tertiary">
    <div class="container">
      <a class="navbar-brand" href="#">
        ...
        <nav class="navbar bg-body-tertiary">
          <div class="container-fluid">
            <a class="navbar-brand">Gaωe World</a>
            <form class="d-flex" role="search">
              <input class="form-control me-2" type="search" placeholder="Cari Diamond,Voucher..." aria-label="Search">
  ...
  <h2> Gaωe Shop</h2>
  <br>
  <h6><a href="https://www.google.com">Lihat semua produk</a></h6>
    ...
    <div class="col-md-3">
      <div class="card" style="width: 18rem;">
        ...
        <div class="card-body">
          ...
          <p class="card-text">Variasikan lina mu dengan Fiery Soul of the Slayer</p>
      ...
      <div class="col">
        <div class="card-news" id="news1">
          ...
          <div class="card-body">
            ...
            <h6><a href="#" onclick="tampilkanBerita('news1')">Lanjutkan baca berita</a></h6>
      ...
      <div class="col">
        <div class="card-news">
          ...
          <div class="card-body">
            ...
            <h6><a href="#" onclick="showNews('news2')">Lanjutkan baca berita</a></h6>
          </div>
        </div>
      </div>
      <div class="col">
        <div class="card-news">
          ...
          <div class="card-body">
            ...
            <h6><a href="#" onclick="showNews('news3')">Lanjutkan baca berita</a></h6>
          </div>
        </div>
      </div>
      <div class="col">
        <div class="card-news">
          ...
          <div class="card-body">
            ...
            <h6><a href="#" onclick="showNews('news4')">Lanjutkan baca berita</a></h6>
          </div>
        </div>
      </div>
    </div>

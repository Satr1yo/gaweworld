...
<head>
    ...
    <title>Tentang Kami - Game Shop</title>
    ...
    <div class="container mt-4">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <p>
                    Gaωe World didirikan pada tahun 2023 dengan visi untuk menjadi pemimpin dalam menyediakan pengalaman berbelanja produk-game berkualitas. Sejak itu, kami telah berkomitmen untuk memberikan layanan terbaik kepada pelanggan kami.
                </p>
            </div>
        </div>
        ...
        <div class="row mt-4">
            <div class="col-md-12">
                ...
                <p>
                    Tim kami terdiri dari individu yang berkomitmen, berbakat, dan berpengalaman dalam industri game. Dengan semangat kreatifitas dan dedikasi, kami bekerja bersama untuk memberikan pengalaman berbelanja yang luar biasa kepada pelanggan kami.
                </p>
            </div>
        </div>
        ...
        <div class="row mt-4">
            <div class="col-md-12">
                <h4>Visi dan Misi</h4>
                <p>
                    <strong>Visi:</strong> Menjadi destinasi utama untuk para gamer yang mencari produk-game berkualitas tinggi dan layanan terbaik.
                </p>
                <p>
                    <strong>Misi:</strong> Memberikan pengalaman berbelanja yang aman, nyaman, dan memuaskan kepada pelanggan kami dengan menyediakan produk-game terbaik dan layanan yang unggul.
                </p>
            </div>
        </div>
    </div>

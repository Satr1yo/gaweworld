...
<nav class="navbar navbar-expand-lg navbar-light bg-body-tertiary">
    <div class="container">
        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item">
                <a class="nav-link text-danger font-weight-bold" href="#">Kembali</a>
            </li>
        </ul>
    </div>
</nav>
            ...
            <div class="col-md-6">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-3 text-center">
                        ...
                        <a href="#" class="btn btn-warning btn-sm">Daftar</a>
                    </div>                    
                </div>
            </div>

                <!-- Navbar untuk "Butuh Bantuan" -->
<nav class="navbar navbar-expand-lg navbar-light bg-body-tertiary fixed-bottom">
    <div class="container">

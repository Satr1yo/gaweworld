...
<head>
    ...
    <title>Detail Produk - Game Shop</title>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
 ...
            </li>
    ...
    <div class="container mt-4">
        ...
        <div class="row">
            <div class="col-md-6">
                <img src="image/ff.jpg" class="img-fluid" alt="Gambar Produk">
            </div>
            <div class="col-md-6">
                <h2>Akun Free Fire Dewa</h2>
                <p class="lead">Akun Sejak Tahun 2019.</p>
                <p><del>Harga: Rp.700.000</del></p>
        ...
        <div class="row mt-4">
            <div class="col-md-12">
                ...
                <p>
                    Akun dengan item lengkap, pangkat, dan status/rank tinggi.
                </p>
                <p>
                    Item permanent dan tidak permanent.
                </p>
                <!-- Lanjutkan dengan deskripsi produk lebih lanjut -->
            </div>
        </div>
    </div>
